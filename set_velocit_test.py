...
def goForXYZ(byX,byY,byZ):# Use byZ positive for UP
    global x,y,z,velocity_factor
    x = byX / velocity_factor
    y = byY / velocity_factor
    z = -byZ / velocity_factor 
...
#Setpoint velocity ayarlandı.
#Görev döngüsü süresi kısaltılıp goXYZ döngüsüne eklendi.
#Döngü süresi kadar hız bölümü yapılıp mesafe ayarlandı.
# !!! MESAFE DOĞRU DEĞİL.
